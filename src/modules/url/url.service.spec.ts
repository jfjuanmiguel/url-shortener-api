...
describe('UrlService', () => {
  ...
  describe(`create`, () => {
    it(`should create a url`, async () => {
      ...
      databaseService.url.create.mockResolvedValue(payload);
  ...
  describe(`findAll`, () => {
    it(`should return array of urls data property`, async () => {
  ...
  describe(`update`, () => {
    it(`should return respective updated url record`, async () => {
      ...
      const payload = { ...original, ...updatedPayload };
      const id = payload.id;
      databaseService.url.update.mockResolvedValueOnce(payload);

      // Act
      const url = await urlService.update(id, updatedPayload);
